...
export class AssetsComponent {
   ...
   protected cardList: ICard[] = [
      ...
      { icon: "apps", title: "Equipamentos", text: "Ver todos os equipamentos", redirectTo: "all", currencyCode: false },
      { icon: "view_in_ar", title: "Ativos do Usuário", text: "Buscar equipamento cadastrado por um usuário", redirectTo: "user-assets", currencyCode: false },
